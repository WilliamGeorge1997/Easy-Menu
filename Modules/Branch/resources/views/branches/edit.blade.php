        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1 d-flex align-items-center gap-2">
                    ...
                    {{ __('dashboard/branches.edit_branch') }}
                </h4>
                <p class="text-muted mb-0" style="font-size: 0.875rem;">
                    {{ __('dashboard/branches.branch_name_location_details') }}
                </p>
            </div>
            <a href="{{ $backUrl }}" class="btn btn-outline-secondary d-flex align-items-center gap-1">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <h6 class="mb-0 fw-semibold">{{ __('dashboard/branches.edit_branch') }}</h6>
                        ...
                        <div class="card-body pt-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" for="title_en">{{ __('dashboard/branches.title_en') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" for="title_ar">{{ __('dashboard/branches.title_ar') }} <span class="text-danger">*</span></label>
                                    <div dir="rtl" class="input-group @error('title_ar') has-validation @enderror">
                                        <span class="input-group-text"><i class="bx bx-text"></i></span>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" for="phone">{{ __('dashboard/branches.phone') }}</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" for="address_en">{{ __('dashboard/branches.address_en') }}</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-medium" for="address_ar">{{ __('dashboard/branches.address_ar') }}</label>
                                    <div dir="rtl" class="input-group @error('address_ar') has-validation @enderror">
                                        <span class="input-group-text"><i class="bx bx-map"></i></span>
                                ...
                                <div class="col-md-6 d-flex align-items-end pb-1">
                                    @if($isSuperAdmin)
                                        <div class="d-flex align-items-center gap-3 p-3 rounded border w-100" style="background: var(--bs-light, #f8f9fa);">
                                            ...
                                            <div>
                                                <label class="form-check-label fw-medium mb-0" for="is_active">{{ __('dashboard/branches.is_active') }}</label>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-header border-bottom pb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">{{ __('dashboard/branches.current_image') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-4">
                            ...
                            <label for="image" id="image-drop-zone"
                                ...
                                <div id="drop-zone-content" @if($branch->getRawOriginal('image')) style="display:none;" @endif>
                                    <div class="mb-3">
                                    ...
                                    <span class="badge bg-label-secondary px-3 py-2" style="font-size:.75rem;">JPG &bull; JPEG &bull; PNG &bull; WEBP</span>
                                </div>
                                <div id="image-preview-wrap" @if($branch->getRawOriginal('image')) style="display:block;width:100%;" @else style="display:none;width:100%;" @endif>
                                    <img id="image-preview" src="{{ $branch->image ?: '#' }}" alt="Preview" class="rounded-3 w-100" style="max-height:200px;object-fit:cover;" />
                                </div>
                            </label>

                            <button type="button" id="remove-image"
                                class="btn btn-sm btn-danger mt-2 w-100 d-flex align-items-center justify-content-center gap-1"
                                @if(!$branch->getRawOriginal('image')) disabled @endif>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ $backUrl }}" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center gap-2" style="padding:.75rem;">
                                <i class="bx bx-x"></i>
                                <span>{{ __('dashboard/branches.cancel') }}</span>
                            </a>
                        </div>
