        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1 d-flex align-items-center gap-2">
                    ...
                    {{ __('dashboard/categories.create_category') }}
                </h4>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <h6 class="mb-0 fw-semibold">{{ __('dashboard/categories.create_category') }}</h6>
                                    <small class="text-muted">{{ __('dashboard/categories.title_en') }} / {{ __('dashboard/categories.title_ar') }}</small>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group @error('title_ar') has-validation @enderror" dir="rtl">
                                        ...
                                        <input type="text" id="title_ar" name="title_ar"
                                            ...
                                            value="{{ old('title_ar') }}"
                                            placeholder="{{ __('dashboard/categories.title_ar') }}"
                                            dir="rtl" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="@error('description_ar') has-validation @enderror">
                                        <textarea id="description_ar" name="description_ar" rows="3"
                                            ...
                                            placeholder="{{ __('dashboard/categories.description_ar') }}"
                        ...
                        <div class="card-header border-bottom pb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">{{ __('dashboard/categories.image') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-4">
                            ...
                            <label for="image" id="image-drop-zone"
                                ...
                                <div id="image-preview-wrap" style="display:none;width:100%;">
                                    <img id="image-preview" src="#" alt="Preview" class="rounded-3 w-100" style="max-height:200px;object-fit:cover;" />
                                </div>
                            </label>
