        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1 d-flex align-items-center gap-2">
                    ...
                    {{ __('dashboard/admins.edit_admin') }}
                </h4>
                    ...
                    <div class="card mb-4">
                        <div class="card-header border-bottom pb-3">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    <h6 class="mb-0 fw-semibold">{{ __('dashboard/admins.edit_admin') }}</h6>
                                    ...
                                    <select id="role_id" name="role_id" class="form-select @error('role_id') is-invalid @enderror">
                                        ...
                                        @foreach($roles as $role)
                                            <option value="{{ $role->id }}"
                                                {{ (string) old('role_id', $admin->roles->first()?->id) === (string) $role->id ? 'selected' : '' }}>
