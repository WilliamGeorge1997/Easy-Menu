...
@section('title', __('dashboard/login.title'))
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-6" action="{{ route('admin.login') }}" method="POST">
                            ...
                            <div class="mb-6 form-password-toggle">
                                <label class="form-label" for="password">{{ __('attributes.password') }}</label>
                                <div class="input-group input-group-merge">
                                    <input type="password" autocomplete="off" id="password" class="form-control"
                                        name="password" placeholder="{{ __('placeholders.password') }}"
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="form-check mb-0">
                                        <input class="form-check-input" type="checkbox" id="remember-me" name="remember_me"
                                            @checked(old('remember_me')) value="1" />
