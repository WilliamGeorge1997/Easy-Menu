                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('admin.login') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" value="1" type="checkbox" id="remember-me" name="remember_me" @checked(old('remember_me')) />
                            ...
                            @enderror
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100 btn-loader" type="submit">Sign in</button>
                            </div>
                        </form>
                    </div>
                </div>
