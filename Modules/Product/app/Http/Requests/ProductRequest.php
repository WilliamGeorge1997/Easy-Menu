...
class ProductRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'discounted_price.numeric' => __('validation.numeric', ['attribute' => __('dashboard/products.discounted_price')]),
            'discounted_price.lte' => __('validation.lte.numeric', ['attribute' => __('dashboard/products.discounted_price'), 'value' => __('dashboard/products.price')]),
