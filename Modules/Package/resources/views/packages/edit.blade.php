...
@section('title', __('dashboard/packages.edit_package'))
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                <h4 class="fw-bold mb-1 d-flex align-items-center gap-2">
                    ...
                    {{ __('dashboard/packages.edit_package') }}
                </h4>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group @error('title_en') has-validation @enderror">
                                        ...
                                        <input type="text" id="title_en" name="title_en"
                                            ...
                                            value="{{ old('title_en', $package->getTranslation('title', 'en')) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group @error('title_ar') has-validation @enderror">
                                        ...
                                        <input type="text" id="title_ar" name="title_ar"
                                            ...
                                            value="{{ old('title_ar', $package->getTranslation('title', 'ar')) }}"
                                            placeholder="{{ __('dashboard/packages.title_ar') }}" dir="rtl" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="description_en" name="description_en" rows="3"
                                        ...
                                        placeholder="{{ __('dashboard/packages.description_en') }}">{{ old('description_en', $package->getTranslation('description', 'en')) }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea id="description_ar" name="description_ar" rows="3"
                                        ...
                                        placeholder="{{ __('dashboard/packages.description_ar') }}" dir="rtl">{{ old('description_ar', $package->getTranslation('description', 'ar')) }}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group @error('months') has-validation @enderror">
                                        ...
                                        <select name="months" id="months" class="form-select @error('months') is-invalid @enderror">
                                            ...
                                            @for($m = 1; $m <= 24; $m++)
                                                <option value="{{ $m }}" {{ (int) old('months', $package->months) === $m ? 'selected' : '' }}>
                                                    {{ $m }}
                                                </option>
                                            @endfor
                                        </select>
