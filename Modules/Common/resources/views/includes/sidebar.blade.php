...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">{{ __('app.name') }}</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item{{ request()->is('admin/dashboard') ? ' active' : '' }}">
            <a href="{{ route('admin.dashboard') }}" class="menu-link">
                ...
                <div class="text-truncate" data-i18n="Email">{{ __('dashboard/sidebar.home') }}</div>
            </a>
        </li>
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text">{{ __('dashboard/sidebar.categories') }} {{ __('dashboard/sidebar.and') }}
                {{ __('dashboard/sidebar.products') }}</span>
        </li>
        ...
        <li class="menu-item{{ request()->is('admin/categories*', 'admin/products*', 'admin/addons*') ? ' active open' : '' }}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div class="text-truncate" data-i18n="Products Managment">
                    {{ __('dashboard/sidebar.products_managment') }}</div>
            </a>
